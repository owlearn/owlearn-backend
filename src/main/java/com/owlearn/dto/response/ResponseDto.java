...
public class ResponseDto<T> {
    ...
    private com.owlearn.dto.exception.ExceptionDto error;
        ...
        return ResponseEntity.status(e.getError().getHttpStatus())
                .body(
                        ResponseDto.builder()
                                .isSuccess(false)
                                .responseDto(null)
                                .error(new com.owlearn.dto.exception.ExceptionDto(e.getError()))
                                .build());
    }
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(
                        ResponseDto.builder()
                                .isSuccess(false)
                                .responseDto(null)
                                .error(new com.owlearn.dto.exception.InvalidateArgumentExceptionDto(e))
                                .build());
    }
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(
                        ResponseDto.builder()
                                .isSuccess(false)
                                .responseDto(null)
                                .error(new com.owlearn.dto.exception.JSONConvertExceptionDto(e))
                                .build());
    }
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(
                        ResponseDto.builder()
                                .isSuccess(false)
                                .responseDto(null)
                                .error(new com.owlearn.dto.exception.ExceptionDto(e))
                                .build());
    }
